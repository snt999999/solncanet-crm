const LS_PASSWORD_KEY = "solncanet_admin_password_v1";
...
const els = {
  ...
  logoutBtn: $("logoutBtn"), refreshBtn: $("refreshBtn"), requestsBody: $("requestsBody"),
...
function init() {
  ...
  els.loginForm.addEventListener("submit", (e) => {
    e.preventDefault();
    localStorage.setItem(LS_PASSWORD_KEY, els.passwordInput.value.trim());
    showApp();
    loadRequests();
  });
...
function openDialog(id) {
  ...
  els.dClient.textContent = f["Имя клиент"] || f["Имя клиента"] || "—";
